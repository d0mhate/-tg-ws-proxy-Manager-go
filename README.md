...
Если локальный cache старее свежего release то `install` сам обновит его
...
- показывает текущую установленную версию
...
Чтобы обновиться на свежий release без лишнего мусора
